package com.poc.jedi.backend.web.rest;
...
import com.poc.jedi.backend.web.rest.errors.ExceptionTranslator;
...
import static com.poc.jedi.backend.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = PocJediBackEndApp.class)
