package com.poc.jedi.backend.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("PocJEDIBackEnd");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("PocJEDIBackEnd");
        ...
        config.getMapConfigs().put("com.poc.jedi.backend.domain.*", initializeDomainMapConfig(jHipsterProperties));
